          ...
          next: async () => {
            ...
            if (!createdUser) {
              this.errorDialog.open(
                ...
                'The created user could not be found'
              )
            ...
            this.peopleService
              ...
              .subscribe({
                ...
                error: err => {
                  this.errorDialog.open('An error occurred while updating the profile', err.message)
                }
              })
          },
          error: err => {
            this.errorDialog.open('An error occurred while creating the user', err.message)
            this.loadingDialog.close()
          }
        })
    })
    ...
    ref.afterClosed().subscribe((data: { user: User; profile: Person; password: string }) => {
      ...
      this.usersService
        ...
        .subscribe({
          ...
          error: err => {
            this.errorDialog.open('An error occurred while updating the user', err.message)
            this.loadingDialog.close()
          }
        })
    })
    ...
    ref.afterClosed().subscribe((data: { user: User; profile: Person }) => {
      ...
      this.usersService
        ...
        .subscribe({
          ...
          error: err => {
            this.errorDialog.open('An error occurred while deleting the product', err.message)
          }
        })
    })
  }
