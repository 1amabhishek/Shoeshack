    ...
    ref.afterClosed().subscribe((product: Product) => {
      ...
      this.productsService
        ...
        .subscribe({
          ...
          error: err => {
            this.errorDialog.open('An error occurred while creating the product', err.message)
          }
        })
    })
  }
    ...
    ref.afterClosed().subscribe((p: Product) => {
      ...
      this.productsService
        ...
        .subscribe({
          ...
          error: err => {
            this.errorDialog.open('An error occurred while updating the product', err.message)
          }
        })
    })
  }
